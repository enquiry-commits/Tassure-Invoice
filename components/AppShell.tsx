...
type SessionUser = { email?: string; name: string; restrictedTo?: string | null; admin?: boolean; canViewReports?: boolean; canViewSgNews?: boolean };
  ...
  return (
    <>
      ...
      <div style={{ display: 'flex', flex: 1, overflow: 'hidden' }}>
        <Sidebar restrictedTo={user?.restrictedTo ?? null} isAdmin={user?.admin ?? false} canViewReports={user?.canViewReports ?? false} canViewSgNews={user?.canViewSgNews ?? false} />
