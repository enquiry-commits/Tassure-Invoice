...
Last updated: 2026-09-09 (Assistant — a batch of real capability gaps found by Vincent stress-testing the chat, plus a second deterministic guard for the same hallucination family that hit outstanding-balance. Four distinct real issues in quick succession, same session:
