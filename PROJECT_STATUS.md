...
Last updated: 2026-09-08 (My Tasks — v1 of the AI-assisted task feature discussed earlier this session (see 2026-09-07's shelved "AI 员工习惯记忆" entry). Vincent: "继续之前提到的AI...最好可以应用在 MY TASKS内，更智能的分析和判断用户要做什么，可以沟通，可以对话，或者是每天打开My Tasks 的时候 AI助手会提醒今天可能会需要完成的任务，优先级是现在，具体的UI，我们会在后面不断的优化形式" — priority now on the logic, UI to keep iterating later.
