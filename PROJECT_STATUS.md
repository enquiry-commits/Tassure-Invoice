...
Last updated: 2026-09-08 (Assistant — management can now ask the My Tasks chat about ANOTHER staff member, AND fully "View As" them for chat, not just Tasks. Two complementary asks in one session, both gated on the existing `canViewAsOthers` flag (not a new permission):
