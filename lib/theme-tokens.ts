...
export const THEME_TOKENS: ThemeTokenDef[] = [
  ...
  // Status
  { key: 'status-success', cssVar: '--status-success', label: '成功色', group: '状态颜色', type: 'color', default: '#16a34a', live: false,
    scope: '尚未接入 —— 预留给后续把页面里写死的同色号迁移进来' },
  { key: 'status-success-tint', cssVar: '--status-success-tint', label: '成功色（浅）', group: '状态颜色', type: 'color', default: '#f0fdf4', live: false,
    scope: '尚未接入 —— 预留' },
  { key: 'status-warning', cssVar: '--status-warning', label: '警告色', group: '状态颜色', type: 'color', default: '#b45309', live: false,
    scope: '尚未接入 —— 预留' },
  { key: 'status-warning-tint', cssVar: '--status-warning-tint', label: '警告色（浅）', group: '状态颜色', type: 'color', default: '#fff7ed', live: false,
    scope: '尚未接入 —— 预留' },
  { key: 'status-danger', cssVar: '--status-danger', label: '危险色', group: '状态颜色', type: 'color', default: '#dc2626', live: false,
    scope: '尚未接入 —— 预留' },
  { key: 'status-danger-tint', cssVar: '--status-danger-tint', label: '危险色（浅）', group: '状态颜色', type: 'color', default: '#fef2f2', live: false,
    scope: '尚未接入 —— 预留' },
  { key: 'status-info-tint', cssVar: '--status-info-tint', label: '提示色（浅）', group: '状态颜色', type: 'color', default: '#eff6ff', live: false,
    scope: '尚未接入 —— 预留' },
  { key: 'accent-blue', cssVar: '--accent-blue', label: '提示色 / 强调蓝', group: '状态颜色', type: 'color', default: '#1d4ed8', live: false,
    scope: '目前只接入了一个系统里还没启用的组件；Billing Drafts、Address Service 里能看到的同色号还是写死的，暂时改了看不到效果' },
  { key: 'accent-orange', cssVar: '--accent-orange', label: '强调橙', group: '状态颜色', type: 'color', default: '#f97316', live: false,
    scope: '同上 —— 只接入了一个还没启用的组件，暂时改了看不到效果' },
  ...
  { key: 'accent-gray', cssVar: '--accent-gray', label: '强调灰', group: '状态颜色', type: 'color', default: '#6b7280', live: false,
    scope: '尚未接入 —— Billing Drafts 里有写死同色号的地方，后续可以接进来' },
  { key: 'accent-red', cssVar: '--accent-red', label: '强调红', group: '状态颜色', type: 'color', default: '#ef4444', live: false,
    scope: '尚未接入 —— Billing Drafts 里有写死同色号的地方，后续可以接进来' },
