...
async function companyUpdatePreviewTool(account: ApprovedAccount | null, input: Record<string, unknown>) {
  ...
  const allowed = ['service:secretary', 'service:accounts', 'service:tax', 'service:xbrl', 'master:remark', 'master:grade', 'customer_source', 'parent_company'];
