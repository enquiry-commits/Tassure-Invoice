...
async function companyUpdatePreviewTool(account: ApprovedAccount | null, input: Record<string, unknown>) {
  ...
  const allowed = ['service:secretary', 'service:accounts', 'service:tax', 'service:xbrl', 'master:remark', 'master:grade', 'trademark:mark_expired_date', 'trademark:status_text', 'trademark:updates_note', 'trademark:remarks', 'customer_source', 'parent_company'];
