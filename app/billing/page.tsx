...
// The row editor + its service badges now live in components/billing/ so the
// chat assistant can render the SAME editor (see that file's own header).
import ExpandedBillingRow, { displayInvoiceNo } from '@/components/billing/ExpandedBillingRow';
...
// BillingInvoiceReference moved to components/billing/BillingInvoiceReference.tsx
// (2026-09-16) so app/billing/soa/_components.tsx's detail modal can use the
// exact same chip — see that file's own header comment.
