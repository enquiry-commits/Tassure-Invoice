  ...
  return (
    <div>
      ...
      <div style={{ background: '#fff', borderRadius: 12, border: '1px solid #e2e8f0', overflow: 'hidden' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '28px 1.6fr 70px 120px 120px 120px 80px', padding: '6px 12px', background: '#f8fafc', borderBottom: '1px solid #e2e8f0' }}>
            ...
            return (
              <div key={c.companyId}>
                <div onClick={() => setExpanded(isOpen ? null : c.companyId)}
                  style={{ display: 'grid', gridTemplateColumns: '28px 1.6fr 70px 120px 120px 120px 80px', alignItems: 'center', padding: '9px 12px', background: isOpen ? '#f0f6ff' : rowBg, borderLeft: `3px solid ${accent}`, borderBottom: '1px solid #f1f5f9', cursor: 'pointer' }}
